                            ...
                            <div className="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                                <div className="card card-plain mt-8">
                                    <div className="card-header pb-0 text-left bg-transparent">
                                        ...
                                        <p className="mb-0">Enter your email, phone number and password to sign up</p>
                                    </div>
                                    <div className="card-body">
                                        <form role="form">
                                            ...
                                            <div className="mb-3">
                                                <input type="tel" className="form-control" placeholder="080********" aria-label="Phone Number" aria-describedby="password-addon" />
                                            </div>
                                    ...
                                    <div className="card-footer text-center pt-0 px-lg-2 px-1">
                                        <p className="mb-4 text-sm mx-auto">
                                            ...
                                            <a href="/signin" className="text-info text-gradient font-weight-bold"> Sign in</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="oblique position-absolute top-0 h-100 d-md-block d-none me-n8 signinBGImg" >
                                    <div className="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 w-100 z-index-0 ms-n6" style={{ backgroundImage: `url(${signinBGImg})` }}></div>
                                </div>
                            </div>
                        </div>
                    </div>
