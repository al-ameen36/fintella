import bgImg from "../../assets/curved-images/curved6.jpg"
import logoImg from "../../assets/img/logo-ct-dark.png"

export default function Sidebar() {
    return (
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl fixed-start bg-light" id="sidenav-main">
            <div className="sidenav-header">
                ...
                <a className="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html">
                    <img src={logoImg} className="navbar-brand-img h-100" alt="main_logo" />
            ...
            <div className="sidenav-footer mx-3 ">
                <div className="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                    <div className="full-background" style={{ backgroundImage: `url(${bgImg})` }}></div>
                    <div className="card-body text-start p-3 w-100">
                        ...
                        <div className="docs-info">
                            ...
                            <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard" className="btn btn-white btn-sm w-100 mb-0">Documentation</a>
                        </div>
                    </div>
                </div>
